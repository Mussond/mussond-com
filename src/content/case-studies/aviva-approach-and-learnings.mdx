...
![Doughnut chart showing '3-Amigos' ownership breakdown with equal 33% shared ownership between Product, Design and Development.](/images/case-studies/aviva_approach_2020_inherited_process.png)
...
- Design leads from other product teams were able to critique patterns early, and started feeding issues or solutions into our backlog
...
![Post-it sketches showing different options for the Progressive Disclosure organism. Simple shows fields appearing between a question; Challenge draws out options for associating the revealed questions with their parent. Complex demonstrates a reveal flow through a model and card interface.](/images/case-studies/aviva_approach_lean_UX_example.png)
...
![Workflow diagram showing the planning and shaping process.](/images/case-studies/aviva_approach_planning_2.png)
...
- Visual designers and UX designers have overlapping roles. Having both disciplines present at the start of a user story meant each could work together and shape the direction simultaneously
